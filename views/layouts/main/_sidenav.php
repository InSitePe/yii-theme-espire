<div class="side-nav">
    <div class="side-nav-inner">
        <div class="side-nav-logo">
            <a href="index.html">
                <div class="logo logo-dark" style="background-image: url('<?=Yii::app()->baseUrl?>/static/images/logo/logo.png')"></div>
                <div class="logo logo-white" style="background-image: url('<?=Yii::app()->baseUrl?>/static/images/logo/logo-white.png')"></div>
            </a>
