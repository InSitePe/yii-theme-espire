                    ...
                    <div class="search-wrapper">
                        <div class="pdd-vertical-10">
                            ...
                            <ul class="list-unstyled list-info">
                                <li>
                                    <a href="">
                                        <img class="thumb-img" src="<?=Yii::app()->baseUrl?>/static/images/avatars/thumb-1.jpg" alt="">
                                        <div class="info">
                                ...
                                <li>
                                    <a href="">
                                        <img class="thumb-img" src="<?=Yii::app()->baseUrl?>/static/images/avatars/thumb-5.jpg" alt="">
                                        <div class="info">
                                ...
                                <li>
                                    <a href="">
                                        <img class="thumb-img" src="<?=Yii::app()->baseUrl?>/static/images/avatars/thumb-4.jpg" alt="">
                                        <div class="info">
                        ...
                        <div class="pdd-vertical-10">
                            ...
                            <ul class="list-unstyled list-info">
                                <li>
                                    <a href="">
                                        <img class="thumb-img" src="<?=Yii::app()->baseUrl?>/static/images/img-1.jpg" alt="">
                                        <div class="info">
                                ...
                                <li>
                                    <a href="">
                                        <img class="thumb-img" src="<?=Yii::app()->baseUrl?>/static/images/img-2.jpg" alt="">
                                        <div class="info">
        ...
        <ul class="nav-right">
            <li class="user-profile dropdown">
                <a href="" class="dropdown-toggle" data-toggle="dropdown">
                    <img class="profile-img img-fluid" src="<?=Yii::app()->baseUrl?>/static/images/user.jpg" alt="">
                    <div class="user-info">
